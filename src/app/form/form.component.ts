...
export class FormComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (this.id != null) {
      this.service.getContactbyId(this.id).subscribe((response) => {
  ...
  addContact(contact: any) {
    if (this.id == null) {
      this.service.addContact(contact).subscribe((responce) => {
        console.log(responce);
        this.router.navigate(['dashboard']);
      })
    } else {
      this.service.updateContact(contact, this.id).subscribe((responce) => {
        console.log(responce);
        this.router.navigate(['dashboard']);
      })
    }
